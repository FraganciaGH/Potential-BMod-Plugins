		...
		int damagecustom, CritType &critType)
{
	...
	&& g_iIsTouchingGas[client] > 0)
	{
		/* Cornfirm: Does this only make afterburn crit or does it apply to any fire? */
